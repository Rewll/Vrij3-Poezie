...
//     version 1.6.3
//     from Assets/Besturing.inputactions
//
...
public partial class @Besturing: IInputActionCollection2, IDisposable
{
    ...
    public struct SpelerBewegingActions
    {
        ...
        public SpelerBewegingActions(@Besturing wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Besturing m_Wrapper;
        public ZomerSpeler1AActions(@Besturing wrapper) { m_Wrapper = wrapper; }
