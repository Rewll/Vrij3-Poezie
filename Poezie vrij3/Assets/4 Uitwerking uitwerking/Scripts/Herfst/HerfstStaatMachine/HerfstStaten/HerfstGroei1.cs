...
public class HerfstGroei1 : HerfstBasisStaat
{
    ...
    {
        GetComponent<HerfstAgent>().huidigeStaat = HerfstAgent.herfstStaten.HerfstGroei1;
    ...
    IEnumerator vliegRoutine()
    {
        ...
        owner.SwitchState(typeof(HerfstGroei2));
    }
